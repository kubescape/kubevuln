...
func (a *APIServerStore) GetApplicationProfile(ctx context.Context, name string) (v1beta1.ApplicationProfile, error) {
	...
	profile, err := a.StorageClient.ApplicationProfiles(a.Namespace).Get(context.Background(), name, metav1.GetOptions{})
	switch {
