...
type CreateSBOMResponse struct {
	...
	ResolvedPlatform string `protobuf:"bytes,6,opt,name=resolved_platform,json=resolvedPlatform,proto3" json:"resolved_platform,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CreateSBOMResponse) GetResolvedPlatform() string {
	if x != nil {
		return x.ResolvedPlatform
	}
	return ""
}
...
const file_scanner_proto_rawDesc = "" +
	...
	" \x01(\x03R\x0etimeoutSeconds\"\xe5\x01\n" +
	...
	"\x11resolved_platform\x18\x06 \x01(\tR\x10resolvedPlatform\"\x0f\n" +
	"\rHealthRequest\"@\n" +
